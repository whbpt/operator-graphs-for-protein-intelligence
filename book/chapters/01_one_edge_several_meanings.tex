...
contain the audited source and take values in the target contrast fiber.  The target category is an
output coordinate, not an assumed input to the masked model.  Under correlated empirical backgrounds, additional cross terms
