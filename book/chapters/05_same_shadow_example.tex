...
\end{equation}
Both have zero row and column means.  Under the uniform references used here, their ordinary
squared Frobenius norms are both $10$, and hence their weighted squared norms are both $10/9$.
Their weighted scalar shadows are therefore identical:
\begin{equation}
